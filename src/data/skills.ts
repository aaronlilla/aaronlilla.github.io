...
export const skillGroups: SkillGroup[] = [
  ...
  {
    title: 'Frontend',
    items: ['React', 'Redux', 'Tailwind CSS', 'Vite', 'Next.js', 'Three.js', 'Design Systems', 'Accessibility (WCAG)'],
  },
  {
    title: 'Backend',
    items: ['Node.js', 'Express', 'REST APIs', 'WebSockets', 'Supabase', 'PostgreSQL', 'SQLite', 'Auth & Sessions'],
  },
  {
